...
public class TransportScenarioModalShiftAssumption {
    ...
    public boolean isValid() {
        return passengerKmMotorcycleBau != null && passengerKmMotorcycleBau >= 0
                ...
                && emissionFactorMotorcycle_gPerPassKm != null && emissionFactorMotorcycle_gPerPassKm >= 0
                ...
                && shiftFractionMotorcycleToBus != null && shiftFractionMotorcycleToBus >= 0 && shiftFractionMotorcycleToBus <= 1
                && shiftFractionCarToBus != null && shiftFractionCarToBus >= 0 && shiftFractionCarToBus <= 1;
    }
}
