...
public class WasteWaterData extends WasteDataAbstract {
    ...
    public Double calculateCH4Emissions() {
        ...
        if (populationRecords == null) {
            throw new IllegalStateException("Population records cannot be null for waste water calculation");
        }
        if (EICVReport == null) {
            throw new IllegalStateException("EICV Report cannot be null for waste water calculation");
        }
