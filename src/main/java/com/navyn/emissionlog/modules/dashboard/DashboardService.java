...
public interface DashboardService {
    ...
    /**
     * Export main dashboard to Excel
     * 
     * @param startingYear start year for report
     * @param endingYear   end year for report
     * @return byte array of Excel file
     */
    byte[] exportMainDashboard(Integer startingYear, Integer endingYear);
}
