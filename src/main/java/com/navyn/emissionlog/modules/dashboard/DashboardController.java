...
public class DashboardController {
    ...
    @GetMapping("/main")
    @Operation(summary = "Get main dashboard", 
               description = "Returns Total N2O, CO2, CH4, CO2eq emissions, Total Mitigation, and Net Emissions (Gross - Mitigation)")
    ...
    @Operation(summary = "Get main dashboard graph data by year",
               description = "Returns yearly breakdown with all emissions, mitigation, and net emissions")
    ...
    @Operation(summary = "Get stationary emissions dashboard",
               description = "Returns Total N2O, CO2, CH4, and CO2eq emissions for stationary sources only")
    ...
    @GetMapping("/waste")
    @Operation(summary = "Get waste emissions dashboard",
               description = "Returns Total N2O, CO2, CH4, and CO2eq emissions for waste sector only")
    ...
    @Operation(summary = "Get agriculture emissions dashboard",
               description = "Returns Total N2O, CO2, CH4, and CO2eq emissions for agriculture sector only")
    ...
    @GetMapping("/landuse")
    @Operation(summary = "Get land use emissions dashboard",
               description = "Returns Total N2O, CO2, CH4, and CO2eq emissions for land use sector only")
