...
private  final  AgricultureEmissionsService agricultureEmissionsService;
    ...
    public ResponseEntity<ApiResponse> getAllLimingEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "limingMaterial") LimingMaterials limingMaterials) {
    ...
    public ResponseEntity<ApiResponse> getAllAquacultureEmissions(@RequestParam(required = false, value = "year") Integer year) {
    ...
    public ResponseEntity<ApiResponse> getAllSyntheticFertilizerEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "fertilizerType") Fertilizers fertilizerType, @RequestParam(required = false, value = "cropType") CropTypes cropType) {
    ...
    public ResponseEntity<ApiResponse> getAllUreaEmissions(@RequestParam(required = false, value = "fertilizerName") String fertilizer, @RequestParam(required = false, value = "year") Integer year) {
    ...
    public ResponseEntity<ApiResponse> getAllRiceCultivationEmissions(@RequestParam(required = false, value = "riceEcosystem") String riceEcosystem, @RequestParam(required = false, value = "waterRegime") WaterRegime waterRegime, @RequestParam(required = false, value = "year") Integer year) {
    ...
    public ResponseEntity<ApiResponse> getAllManureAndCompostEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "amendmentType") OrganicAmendmentTypes amendmentType, @RequestParam(required = false, value = "species") LivestockSpecies species) {
    ...
    public ResponseEntity<ApiResponse> getAllEntericFermentationEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "species") LivestockSpecies species) {
    ...
    public ResponseEntity<ApiResponse> createLimingEmissions(@Valid @RequestBody LimingEmissionsDto limingEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> createAquacultureEmissions(@Valid @RequestBody AquacultureEmissionsDto aquacultureEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> createSyntheticFertilizerEmissions(@Valid @RequestBody SyntheticFertilizerEmissionsDto syntheticFertilizerEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> createRiceCultivationEmissions(@Valid @RequestBody RiceCultivationEmissionsDto riceCultivationEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> createManureAndCompostEmissions(@Valid @RequestBody AnimalManureAndCompostEmissionsDto manureAndCompostEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> createBurningEmissions(@Valid @RequestBody BurningEmissionsDto burningEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllBurningEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "forestType") BurningAgentType forestType) {
    ...
    public ResponseEntity<ApiResponse> createCropResidueEmissions(@Valid @RequestBody CropResiduesEmissionsDto cropResidueEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllCropResidueEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "cropType") CropResiduesCropType cropType, @RequestParam(required = false, value = "landUseCategory") LandUseCategory landUseCategory) {
    ...
    public ResponseEntity<ApiResponse> createPastureExcretionEmissions(@Valid @RequestBody PastureExcretionsEmissionsDto pastureExcretionEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllPastureExcretionEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "category") LivestockSpecies species, @RequestParam(required = false, value = "mms") MMS mms) {
    ...
    public ResponseEntity<ApiResponse> createMineralSoilEmissions(@Valid @RequestBody MineralSoilEmissionsDto mineralSoilEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllMineralSoilEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "initialLandUse") LandUseCategory initialLandUse, @RequestParam(required = false, value = "landUseInReportingYear") LandUseCategory landUseInReportingYear) {
    ...
    public ResponseEntity<ApiResponse> createVolatilizationEmissions(@Valid @RequestBody VolatilizationEmissionsDto volatilizationEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllVolatilizationEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "mms") MMS mms, @RequestParam(required = false, value = "species") LivestockSpecies species) {
    ...
    public ResponseEntity<ApiResponse> createLeachingEmissions(@Valid @RequestBody LeachingEmissionsDto leachingEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllLeachingEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "mms") MMS mms, @RequestParam(required = false, value = "species") LivestockSpecies species) {
    ...
    public ResponseEntity<ApiResponse> createAtmosphericNDepositionEmissions(@Valid @RequestBody AtmosphericDepositionEmissionsDto atmosphericNDepositionEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllAtmosphericNDepositionEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "landUseCategory") LandUseCategory landUseCategory) {
    ...
    public ResponseEntity<ApiResponse> createLeachingAndRunoffEmissions(@Valid @RequestBody LeachingAndRunoffEmissionsDto leachingAndRunoffEmissionsDto) {
    ...
    public ResponseEntity<ApiResponse> getAllLeachingAndRunoffEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "landUseCategory") LandUseCategory landUseCategory) {
    ...
    public ResponseEntity<ApiResponse> createManureManagementEmissions(@Valid @RequestBody ManureManagementEmissionsDto dto) {
    ...
    public ResponseEntity<ApiResponse> getAllManureManagementEmissions(@RequestParam(required = false, value = "year") Integer year, @RequestParam(required = false, value = "species") ManureManagementLivestock species) {
        List<ManureManagementEmissions> emissions = agricultureEmissionsService.getAllManureManagementEmissions(year, species);
    ...
    public ResponseEntity<ApiResponse> updateAquacultureEmissions(@PathVariable UUID id, @Valid @RequestBody AquacultureEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Aquaculture emissions updated successfully", agricultureEmissionsService.updateAquacultureEmissions(id, dto)));
    }

    @PutMapping("/entericFermentationEmissions/{id}")
    @Operation(summary = "Update enteric fermentation emissions record")
    public ResponseEntity<ApiResponse> updateEntericFermentationEmissions(@PathVariable UUID id, @Valid @RequestBody EntericFermentationEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Enteric Fermentation emissions updated successfully", agricultureEmissionsService.updateEntericFermentationEmissions(id, dto)));
    }

    @PutMapping("/limingEmissions/{id}")
    @Operation(summary = "Update liming emissions record")
    public ResponseEntity<ApiResponse> updateLimingEmissions(@PathVariable UUID id, @Valid @RequestBody LimingEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Liming emissions updated successfully", agricultureEmissionsService.updateLimingEmissions(id, dto)));
    }

    @PutMapping("/animalManureAndCompostEmissions/{id}")
    @Operation(summary = "Update animal manure and compost emissions record")
    public ResponseEntity<ApiResponse> updateAnimalManureAndCompostEmissions(@PathVariable UUID id, @Valid @RequestBody AnimalManureAndCompostEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Animal Manure and Compost emissions updated successfully", agricultureEmissionsService.updateAnimalManureAndCompostEmissions(id, dto)));
    }

    @PutMapping("/riceCultivationEmissions/{id}")
    @Operation(summary = "Update rice cultivation emissions record")
    public ResponseEntity<ApiResponse> updateRiceCultivationEmissions(@PathVariable UUID id, @Valid @RequestBody RiceCultivationEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Rice Cultivation emissions updated successfully", agricultureEmissionsService.updateRiceCultivationEmissions(id, dto)));
    }

    @PutMapping("/syntheticFertilizerEmissions/{id}")
    @Operation(summary = "Update synthetic fertilizer emissions record")
    public ResponseEntity<ApiResponse> updateSyntheticFertilizerEmissions(@PathVariable UUID id, @Valid @RequestBody SyntheticFertilizerEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Synthetic Fertilizer emissions updated successfully", agricultureEmissionsService.updateSyntheticFertilizerEmissions(id, dto)));
    }

    @PutMapping("/ureaEmissions/{id}")
    @Operation(summary = "Update urea emissions record")
    public ResponseEntity<ApiResponse> updateUreaEmissions(@PathVariable UUID id, @Valid @RequestBody UreaEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Urea emissions updated successfully", agricultureEmissionsService.updateUreaEmissions(id, dto)));
    }

    @PutMapping("/burningEmissions/{id}")
    @Operation(summary = "Update burning emissions record")
    public ResponseEntity<ApiResponse> updateBurningEmissions(@PathVariable UUID id, @Valid @RequestBody BurningEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Burning emissions updated successfully", agricultureEmissionsService.updateBurningEmissions(id, dto)));
    }

    @PutMapping("/cropResidueEmissions/{id}")
    @Operation(summary = "Update crop residue emissions record")
    public ResponseEntity<ApiResponse> updateCropResidueEmissions(@PathVariable UUID id, @Valid @RequestBody CropResiduesEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Crop Residue emissions updated successfully", agricultureEmissionsService.updateCropResidueEmissions(id, dto)));
    }

    @PutMapping("/pastureExcretionEmissions/{id}")
    @Operation(summary = "Update pasture excretion emissions record")
    public ResponseEntity<ApiResponse> updatePastureExcretionEmissions(@PathVariable UUID id, @Valid @RequestBody PastureExcretionsEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Pasture Excretion emissions updated successfully", agricultureEmissionsService.updatePastureExcretionEmissions(id, dto)));
    }

    @PutMapping("/mineralSoilEmissions/{id}")
    @Operation(summary = "Update mineral soil emissions record")
    public ResponseEntity<ApiResponse> updateMineralSoilEmissions(@PathVariable UUID id, @Valid @RequestBody MineralSoilEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Mineral Soil emissions updated successfully", agricultureEmissionsService.updateMineralSoilEmissions(id, dto)));
    }

    @PutMapping("/volatilizationEmissions/{id}")
    @Operation(summary = "Update volatilization emissions record")
    public ResponseEntity<ApiResponse> updateVolatilizationEmissions(@PathVariable UUID id, @Valid @RequestBody VolatilizationEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Volatilization emissions updated successfully", agricultureEmissionsService.updateVolatilizationEmissions(id, dto)));
    }

    @PutMapping("/leachingEmissions/{id}")
    @Operation(summary = "Update leaching emissions record")
    public ResponseEntity<ApiResponse> updateLeachingEmissions(@PathVariable UUID id, @Valid @RequestBody LeachingEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Leaching emissions updated successfully", agricultureEmissionsService.updateLeachingEmissions(id, dto)));
    }

    @PutMapping("/atmosphericNDepositionEmissions/{id}")
    @Operation(summary = "Update atmospheric N deposition emissions record")
    public ResponseEntity<ApiResponse> updateAtmosphericNDepositionEmissions(@PathVariable UUID id, @Valid @RequestBody AtmosphericDepositionEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Atmospheric Deposition emissions updated successfully", agricultureEmissionsService.updateAtmosphericNDepositionEmissions(id, dto)));
    }

    @PutMapping("/leachingAndRunoffEmissions/{id}")
    @Operation(summary = "Update leaching and runoff emissions record")
    public ResponseEntity<ApiResponse> updateLeachingAndRunoffEmissions(@PathVariable UUID id, @Valid @RequestBody LeachingAndRunoffEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Leaching and Runoff emissions updated successfully", agricultureEmissionsService.updateLeachingAndRunoffEmissions(id, dto)));
    }

    @PutMapping("/manureManagementEmissions/{id}")
    @Operation(summary = "Update manure management emissions record")
    public ResponseEntity<ApiResponse> updateManureManagementEmissions(@PathVariable UUID id, @Valid @RequestBody ManureManagementEmissionsDto dto) {
        return ResponseEntity.ok(new ApiResponse(true, "Manure Management emissions updated successfully", agricultureEmissionsService.updateManureManagementEmissions(id, dto)));
    }
    ...
    public ResponseEntity<ApiResponse> getAgricultureDashboardSummary(@RequestParam(required = false, value = "startingYear") Integer startingYear, @RequestParam(required = false, value = "endingYear") Integer endingYear) {
        return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse(true, "Agriculture dashboard summary fetched successfully", agricultureEmissionsService.getAgricultureDashboardSummary(startingYear, endingYear)));
    }
    ...
    public ResponseEntity<ApiResponse> getAgricultureDashboardGraph(@RequestParam(required = false, value = "startingYear") Integer startingYear, @RequestParam(required = false, value = "endingYear") Integer endingYear) {
        return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse(true, "Agriculture dashboard graph fetched successfully", agricultureEmissionsService.getAgricultureDashboardGraph(startingYear, endingYear)));
    }
}
