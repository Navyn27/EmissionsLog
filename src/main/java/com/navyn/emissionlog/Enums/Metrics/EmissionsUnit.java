...
public enum EmissionsUnit {
    ...
    TONNES_CO2E(1.0),           // tonnes CO₂e (standard)
    KILOGRAMS_CO2E(0.001),      // kg CO₂e
    GRAMS_CO2E(0.000001),       // g CO₂e
    MEGATONNES_CO2E(1000.0),    // Mt CO₂e
    KILOTONNES_CO2E(1000.0);    // kt CO₂e
     ...
     */
    public double toTonnesCO2e(double value) {
